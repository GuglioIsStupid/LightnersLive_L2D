...
function lancerWalker:init()
    ...
    self._anims = {
        idle = {
            love.graphics.newImage(getPath("Lancer/Lancer.png"))
        }
    }
    ...
    self.splatSound = love.audio.newSource("assets/snd/lancerSplat.wav", "static")

    print("Lancer 'Walker' initialized with animations for directions: down, up, left, right")
end

function lancerWalker:play()
    self.splatSound:clone():play()
    self.visible = true
end
