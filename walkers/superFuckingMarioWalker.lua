...
function lancerWalker:init()
    ...
    self.scale = 0.25 ---@type number -- Scale factor for the walker

    self._anims = {
        idle = {
            love.graphics.newImage(getPath("1386512276244140133.png"))
        }
    }
    ...
    print("SuperFuckingMario 'Walker' initialized with animations for directions: down, up, left, right")
end
